...
message1=" I would like to have DBVisualizer on my Mac.  My Mac's system name is:  "

# set the destination address
email=itsupport@onekingslane.com

echo "#tags dbviz selfservice \n ***This is an automatically generated message*** \n $message1$hostname \n My logged in user is $user and my JSS ID is $jssID \n " | mail -s "DBVisualizer Request" $email -f $c
